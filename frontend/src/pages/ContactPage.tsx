      ...
      <article>
        ...
        <section className="grid sm:grid-cols-2 gap-6 mb-10">
          <div className="glass-card">
            ...
            <a href="mailto:contact@kaboom-tv.com" className="text-amber-400 hover:underline text-sm">
              contact@kaboom-tv.com
            </a>
          </div>
          <div className="glass-card">
            <h3 className="font-semibold text-white mb-2">Partnerships</h3>
            <a href="mailto:collaborate@kaboom-tv.com" className="text-amber-400 hover:underline text-sm">
          ...
          <form onSubmit={handleSubmit} className="glass-card space-y-4">
            <div className="grid sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white text-sm focus:outline-none focus:border-amber-500/50"
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white text-sm resize-none focus:outline-none focus:border-amber-500/50"
