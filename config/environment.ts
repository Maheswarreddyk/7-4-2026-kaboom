...
export const environment = {
  ...
  backend: {
    ...
    allowedOrigins: (isBackend ? (process.env.ALLOWED_ORIGINS || 'http://localhost:5173,http://127.0.0.1:5173,http://localhost:4173,http://localhost:5000,http://localhost:10000,https://kaboom-tv.com,https://www.kaboom-tv.com,https://api.kaboom-tv.com,https://seven-4-2026-kaboom-1a.onrender.com') : '')
      .split(',')
      .map((o: string) => o.trim())
      .filter(Boolean),
  },
